...
The app facilitates data checking and analysis by providing a simple interface.
...
See the [user guide](https://poissonconsulting.github.io/bisonpicsuite/articles/bisonpic-user-guide.html) for step-by-step instructions on how to use the app.
